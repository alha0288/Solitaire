...
class Card(abstract.AbstractImage):
    ...
    # As static members are loaded before __main__ I cannot load the back_of_card image right away This is because
    # abstract.loadImage() calls a pygame function (convert_alpha) that requires pygame.init() to be called This
    # static function can be called to load the back_of_card image
    @staticmethod
    def loadBack(name):
